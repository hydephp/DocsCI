            ...
            <article class="bg-white p-4 rounded-lg shadow-xl">
                ...
                <div class="py-4 prose">
                    ...
                    <a href="https://github.com/hydephp/hyde/actions/workflows/tests.yml"><img
                        style="display: inline; margin: 4px 2px;"
                        src="https://github.com/hydephp/hyde/actions/workflows/tests.yml/badge.svg"
                        alt="GitHub Actions Test Suite"></a>
                    <a href="https://github.com/hydephp/hyde/actions/workflows/codeql-analysis.yml"><img
                        style="display: inline; margin: 4px 2px;"
                        src="https://github.com/hydephp/hyde/actions/workflows/codeql-analysis.yml/badge.svg"
                        alt="GitHub Actions CodeQL Analysis"></a>
            ...
            <article class="bg-white p-4 rounded-lg shadow-xl">
                ...
                <div class="py-4 prose">
                    ...
                    <img style="display: inline; margin: 4px 2px;"
                        src="https://img.shields.io/badge/coverage-85%25-yellowgreen" alt="Test Coverage"
                        title="Test coverage generated 2022-03-28">
