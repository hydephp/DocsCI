			...
			<ul>
			  <li class="flex items-center py-2 space-x-4 xl:py-3">
				...
				<span class="font-medium text-gray-600 dark:text-gray-300">
					Laravel developers wanting build a static site without having to learn a new framework.
				</span>
			  </li>
			  <li class="flex items-center py-2 space-x-4 xl:py-3">
			  ...
			  <li class="flex items-center py-2 space-x-4 xl:py-3">
				...
				<span class="font-medium text-gray-600 dark:text-gray-300">Developers who wants to get documentation site up and running quickly, allowing them to focus on content.</span>
			  </li>
			</ul>
		  </div>
		</div>
