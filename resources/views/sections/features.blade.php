		...
		<div class="flex flex-wrap items-center sm:-mx-3">
			<div class="w-full md:w-1/2 md:px-3">
				<div class="w-full pb-6 space-y-6 sm:max-w-md lg:max-w-lg md:space-y-4 lg:space-y-8 xl:space-y-9 sm:pr-5 lg:pr-0 md:pb-0">
					...
					<a href="docs/master/index.html" class="flex items-center px-6 py-3 text-gray-700 dark:text-gray-200 bg-gray-300 dark:bg-gray-600 hover:dark:bg-gray-700 rounded-md hover:bg-gray-300 hover:text-gray-600">
						Explore the docs
					</a>
				</div>
			</div>
